...
function runSummaryMessage(result) {
  if (result?.demoReplay) {
    ...
    return `I’m rebuilding the public-source sheet now — ${total} real row(s) will appear with why-it-matched notes, contact routes, and review angles.`;
  }
...
const CLAWDIFIED_AGENT_PROFILE = {
  ...
  output: "a public-source lead sheet with contact routes, source notes, review labels, and a safe next-step angle",
};

const DEFAULT_RUN_CRITERIA = {
  searchQuery: "Business context + ICP: service businesses with follow-up-heavy workflows",
  geographySegment: "Target service area",
  targetWeeklyVolume: 5,
};

const CLAWDIFIED_SHOWROOM_PROVIDERS = {
  publicDiscovery: { provider: "Business search", purpose: "Find public-source companies that match the ICP", configured: true, required: true, status: "ready" },
  ...
  contactEnrichment: { provider: "Contact routes", purpose: "Attach real public ways a human could review or reach the business", configured: true, required: true, status: "ready" },
...
const CLAWDIFIED_SHOWROOM_RAW_LEADS = [
  {
    ...
    companyName: "Marshall Cleaning Service",
    domain: "marshallcleaningservice.com",
    website: "https://marshallcleaningservice.com/",
    personName: "Brian Marshall",
    title: "Founder",
    roleCategory: "Leadership",
    departmentFunction: "Operations",
    industryCategory: "Residential and commercial cleaning",
    fitBand: "Local service business · repeat scheduling",
    geographySegment: "Knoxville, TN",
    city: "Knoxville",
    state: "TN",
    email: "office@marshallcleaningservice.com",
    emailConfidence: "HIGH",
    phone: "865-213-1601",
    phoneType: "company",
    contactConfidence: "HIGH",
    contactPageUrl: "https://marshallcleaningservice.com/",
    publicContactPath: "Call or request service through the official Marshall Cleaning Service site.",
    clawdifiedCompatibilityScore: 91,
    tamFitScore: 91,
    compatibilityConfidence: "HIGH",
    isFinishedEnrichedLead: true,
    researchStatus: "finished",
    missingFields: "",
    scoreReasons: "Official team page says Brian founded the company after seeing a need for residential and commercial cleaning in Knoxville; the site shows recurring service categories, online deals, and request-service calls to action.",
    scoreRisks: "Use the company contact route; do not assume a direct personal inbox unless it is published.",
    workflowPainClues: "Recurring service requests, same-day cleaning, financing, reminders, and interior/exterior job scheduling can create repeat office follow-up.",
    reasonToContact: "Lead with the repeat scheduling and service-request workflow, not generic AI.",
    suggestedFirstCallAngle: "Ask where new service requests, reminders, and recurring customer follow-up still get handled manually.",
    suggestedAgent: "Service request + recurring follow-up agent",
    sourceUrls: "https://marshallcleaningservice.com/meet-the-team.html; https://marshallcleaningservice.com/",
    sourceQuality: "PUBLIC_SITE_PROFILED",
    providerSourceUsed: "Business search; official site review; contact route review; review sheet builder",
    emailVerificationStatus: "PUBLIC_SITE_LISTED",
    fitConfidence: "Public-source directional",
  },
  {
    id: "public-source-002",
    companyName: "Marshall Cleaning Service",
    domain: "marshallcleaningservice.com",
    website: "https://marshallcleaningservice.com/",
    personName: "Daniel Falkner",
    title: "Manager of Operations",
    roleCategory: "Operations",
    departmentFunction: "Operations",
    industryCategory: "Residential and commercial cleaning",
    fitBand: "Local service business · field operations",
    geographySegment: "Knoxville, TN",
    city: "Knoxville",
    state: "TN",
    email: "office@marshallcleaningservice.com",
    ...
    phoneType: "company",
    contactConfidence: "HIGH",
    contactPageUrl: "https://marshallcleaningservice.com/meet-the-team.html",
    publicContactPath: "Use the official office email or phone listed by Marshall Cleaning Service.",
    clawdifiedCompatibilityScore: 88,
    tamFitScore: 88,
    compatibilityConfidence: "HIGH",
    isFinishedEnrichedLead: true,
    researchStatus: "finished",
    missingFields: "",
    scoreReasons: "Official team page lists Daniel Falkner as manager of operations; that role is close to scheduling, dispatch, job quality, and customer follow-up workflows.",
    scoreRisks: "The public contact route is company-level, not a direct personal phone.",
    workflowPainClues: "This role can absorb schedule changes, service reminders, job notes, customer questions, and internal handoffs.",
    reasonToContact: "Lead with an operations-support workflow tied to service scheduling and job follow-up.",
    suggestedFirstCallAngle: "Ask how service requests, recurring jobs, and customer updates move from the office to field teams today.",
    suggestedAgent: "Operations handoff + customer update agent",
    sourceUrls: "https://marshallcleaningservice.com/meet-the-team.html; https://marshallcleaningservice.com/",
    sourceQuality: "PUBLIC_SITE_PROFILED",
    providerSourceUsed: "Business search; official site review; contact route review; review sheet builder",
    emailVerificationStatus: "PUBLIC_SITE_LISTED",
  ...
  {
    id: "public-source-003",
    companyName: "Knoxville Smiles at Malone & Costa Dentistry",
    domain: "knoxvillesmiles.com",
    website: "https://www.knoxvillesmiles.com/",
    personName: "Dr. Stephen Malone",
    title: "Dentist",
    roleCategory: "Healthcare provider",
    departmentFunction: "Practice leadership",
    ...
    phoneType: "company",
    contactConfidence: "HIGH",
    contactPageUrl: "https://www.knoxvillesmiles.com/contact-us/",
    publicContactPath: "Use the official Knoxville Smiles contact page or office phone.",
    ...
    researchStatus: "finished",
    missingFields: "",
    scoreReasons: "Official Knoxville Smiles pages list Dr. Stephen Malone and show appointment/contact routes, online booking, patient forms, and multiple front-office workflows.",
    scoreRisks: "No direct public personal email was used; outreach should go through the office route.",
    workflowPainClues: "New-patient questions, appointment reminders, patient forms, and review requests can consume front-desk time.",
    reasonToContact: "Lead with front-office follow-up and patient intake, not a broad AI pitch.",
    suggestedFirstCallAngle: "Ask how many patient reminders, forms, and appointment follow-ups the front desk handles each week.",
    suggestedAgent: "Patient intake + reminder agent",
    sourceUrls: "https://www.knoxvillesmiles.com/meet-the-team/; https://www.knoxvillesmiles.com/dr-stephen-malone/; https://www.knoxvillesmiles.com/contact-us/",
    sourceQuality: "PUBLIC_SITE_PROFILED",
    providerSourceUsed: "Business search; official site review; contact route review; review sheet builder",
    emailVerificationStatus: "NOT_PUBLICLY_LISTED",
    fitConfidence: "Public-source directional",
  },
  {
    id: "public-source-004",
    companyName: "Asset Realty Management",
    domain: "knoxvilleproperty.management",
    website: "https://www.knoxvilleproperty.management/",
    personName: "Mike Yarbrough",
    title: "Broker",
    roleCategory: "Leadership",
    departmentFunction: "Property management",
    industryCategory: "Property management",
    fitBand: "Property team · tenant and owner updates",
    geographySegment: "Knoxville, TN",
    city: "Knoxville",
    state: "TN",
    email: "Mike@armtn.com",
    emailConfidence: "HIGH",
    phone: "865.247.0027",
    phoneType: "company",
    contactConfidence: "HIGH",
    contactPageUrl: "https://www.knoxvilleproperty.management/contact",
    publicContactPath: "Use the official Asset Realty Management contact page, company phone, or listed broker email.",
    clawdifiedCompatibilityScore: 90,
    tamFitScore: 90,
    compatibilityConfidence: "HIGH",
    isFinishedEnrichedLead: true,
    researchStatus: "finished",
    missingFields: "",
    scoreReasons: "Official Asset Realty Management about page lists Mike Yarbrough as Broker and the site exposes owner, tenant, maintenance, leasing, and contact workflows.",
    scoreRisks: "Use published contact routes only; do not rely on template placeholder phone numbers embedded elsewhere on the page.",
    workflowPainClues: "Tenant requests, owner updates, maintenance coordination, leasing questions, and document follow-up can fragment across portals, calls, and email.",
    reasonToContact: "Lead with tenant/owner update automation and maintenance request follow-up.",
    suggestedFirstCallAngle: "Ask where owner updates, tenant requests, and maintenance follow-up still require manual chasing.",
    suggestedAgent: "Tenant request + owner update agent",
    sourceUrls: "https://www.knoxvilleproperty.management/about; https://www.knoxvilleproperty.management/contact",
    sourceQuality: "PUBLIC_SITE_PROFILED",
    providerSourceUsed: "Business search; official site review; contact route review; review sheet builder",
    emailVerificationStatus: "PUBLIC_SITE_LISTED",
    fitConfidence: "Public-source directional",
  ...
  {
    id: "public-source-005",
    companyName: "Asset Realty Management",
    domain: "knoxvilleproperty.management",
    website: "https://www.knoxvilleproperty.management/",
    personName: "Marie Sharpe",
    title: "Affiliate Broker / Property Manager",
    roleCategory: "Operations",
    departmentFunction: "Property management",
    industryCategory: "Property management",
    fitBand: "Property team · service coordination",
    geographySegment: "Knoxville, TN",
    city: "Knoxville",
    state: "TN",
    email: "marie@armtn.com",
    emailConfidence: "HIGH",
    phone: "865.247.0027",
    phoneType: "company",
    contactConfidence: "HIGH",
    contactPageUrl: "https://www.knoxvilleproperty.management/contact",
    publicContactPath: "Use the official Asset Realty Management contact page, company phone, or listed property-manager email.",
    ...
    researchStatus: "finished",
    missingFields: "",
    scoreReasons: "Official Asset Realty Management about page says Marie Sharpe works in property management and sales; that role is close to tenant, vendor, owner, and follow-up coordination.",
    scoreRisks: "Keep the first message tied to property-management operations rather than a generic software pitch.",
    workflowPainClues: "Property managers handle tenant questions, vendor scheduling, owner updates, lease/admin tasks, and recurring follow-up.",
    reasonToContact: "Lead with reducing repetitive tenant/vendor/owner follow-up.",
    suggestedFirstCallAngle: "Ask which tenant, vendor, or owner follow-ups repeat every week and still need a human to approve the final answer.",
    suggestedAgent: "Property management follow-up agent",
    sourceUrls: "https://www.knoxvilleproperty.management/about; https://www.knoxvilleproperty.management/contact",
    sourceQuality: "PUBLIC_SITE_PROFILED",
    providerSourceUsed: "Business search; official site review; contact route review; review sheet builder",
    emailVerificationStatus: "PUBLIC_SITE_LISTED",
...
function buildClawdifiedShowroomRun(leads = CLAWDIFIED_SHOWROOM_RAW_LEADS) {
  ...
  return {
    ...
    runId: `lead-growth-public-${Date.now().toString(36)}`,
    searchGeographySegment: "Knoxville, TN public-source run",
    searchQuery: "Business context + ICP: service businesses with follow-up-heavy workflows",
    rawCompaniesFound: 5,
    companiesExcluded: 0,
    peopleFound: 5,
    finishedEnrichedLeadsAdded: leads.length,
    incompleteAccountsSaved: 0,
    duplicatesMerged: 0,
    sourcesUsed: ["Business search", "Source review", "Contact routes", "Review sheet builder"],
    providerFailuresBlocks: [],
    emailCoverage: "4/5 public email routes",
    phoneCoverage: "5/5 company phone routes",
    linkedInCoverage: "0/5 LinkedIn routes",
    facebookCoverage: "0/5 Facebook routes",
    ...
    linkedInSocialCoverage: "5/5 official profile/contact routes",
    duplicateIdCount: 0,
    badSourceCount: 0,
    badSourceDomains: [],
    sourceCoverageSummary: "Public-source run: the Lead Growth agent starts from business context + ICP, checks official websites/profile/contact pages, and writes a sheet a human can review.",
    shortfall: "None in public-source preview",
...
const App = () => {
  ...
  async function runNow(context = {}) {
    ...
    if (PUBLIC_DEMO_MODE) {
      setRunNotice("I’m reading the business context + ICP, then checking official public sources for matching companies and people…");
      try {
    ...
    setRunNotice(demoReplayMode ? "Starting public-source preview…" : "Starting Run Agent…");
    try {
      let result;
      if (!demoReplayMode) {
  ...
  async function clearDemoSheet() {
    if (PUBLIC_DEMO_MODE) {
      ...
      setSelectedId(null);
      setPanelOpen(false);
      setRunNotice("I cleared the public-source sheet. Run the agent again when you want me to rebuild it from the business context + ICP.");
      setError("");
      return;
    }
    if (!agentStatus?.demoReplayMode) {
      setError("Clear sheet is only available in public-source preview mode.");
      return;
    }
  ...
  const demoClearDisabledReason = PUBLIC_DEMO_MODE
    ? (demoHasRowsOrRuns ? "" : "Public-source sheet is already clear.")
