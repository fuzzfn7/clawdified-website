...
export async function onRequestGet(context) {
  ...
  if (!ready.ok) {
    return json({
      ok: false,
      error: 'Social connector admin API is not fully configured.',
  ...
  return json({
    ...
    warning: 'Dashboard rows are safe summaries. Use a row detail/package action to retrieve the sensitive Meta agent handoff package intentionally.',
  });
}
