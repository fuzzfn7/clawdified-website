...
test('primary links sit directly in the bar instead of a nested menu pill', () => {
...
test('header keeps simple navigation and one decisive project CTA', () => {
...
test('inset shell remains calm and usable when secondary links collapse', () => {
  ...
  assert.match(html, /\.nav nav a:not\(\.nav-cta\)\{display:none\}/);
