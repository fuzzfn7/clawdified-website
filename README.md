...
- Homepage source: the Heritage Flow experience with production SEO metadata, transparent claw, pixel-exact responsive Industrial Notch wordmarks derived from the approved vector master, and the approved creamy social-profile artwork for browser and installed-app identity.
- Reviewed release identity: `index.html` SHA-256 `e82650388c438ac647ab383a2c06477f097fb5d7477baa7a31617256a99d07e0`; responsive wordmark SHA-256 values are `ff1f1aa4e2d4a52ac11af4a1e87f20faae3adf2dff49750f95d3d5ff7c0f61a9` (1×), `21335bf3507f7258b20f4004aa4e7b55d0273bd3b530b34964776520249b6424` (2×), and `d18332f2e9b27c3627f926e6ece4c6106907111df442cf68d3998cebed214120` (3×).
...
- Browser, iOS, and Android/Samsung install icons derive from the approved `assets/clawdified-social-profile-final.png` creamy social-profile master (SHA-256 `c0893e3b81034759466cabc5553ebc7f688480d3ab9294ba35c918a50a448b4a`). The cache-distinct 64px browser favicon is `/assets/clawdified-social-profile-favicon-64.png` (SHA-256 `6de03c9b6b11feaf707778c4307c068e5414345d531dfefa75b4c6566e4eca70`); iOS uses the opaque 180px `/clawdified-social-profile-apple-touch-icon.png`; the web manifest uses opaque 192px and 512px icons with `purpose: any maskable` for Android and Samsung home-screen crops.
- Release gates: `145/145` repository tests, `59/59` curated-release HTTP contracts, `10/10` rendered desktop/mobile checks, exact staged-release hash checks, and Lighthouse SEO `100` on the homepage and Knoxville page.
